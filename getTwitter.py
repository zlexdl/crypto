...
while True:
    ...
    try:
        ...
        Candysong9 = api.user_timeline(screen_name='Candysong9', count=3, tweet_mode='extended')
        HoppyMeme = api.user_timeline(screen_name='HoppyMeme', count=3, tweet_mode='extended')
        ibcig = api.user_timeline(screen_name='ibcig', count=3, tweet_mode='extended')
        ...
        fantomstarter = api.user_timeline(screen_name='fantomstarter', count=3, tweet_mode='extended')
        print("---------------------public_tweets")
        public_tweets = CryptoFaibik + ElemonGame + top7ico + Candysong9 + HoppyMeme + ibcig + RaccoonHKG + blokpad +bloktopia + fantomstarter
